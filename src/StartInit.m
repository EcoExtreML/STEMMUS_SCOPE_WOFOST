...
global InitND1 InitND2 InitND3 InitND4 InitND5 BtmT BtmX Btmh InitND6 computerPlatform% Preset the measured depth to get the initial T, h by interpolation method.
...
TCON(1)=1.37e-3*4.182;TCON(2)=6e-5*4.182;TCON(3)=2.1e-2*4.182;TCON(4)=7e-3*4.182;TCON(5)=6e-4*4.182;TCON(6)=5.2e-3*4.182;%TCON(1)=1.37e-3*4.182;TCON(2)=6e-5*4.182;TCON(3)=2.1e-2*4.182;TCON(4)=7e-3*4.182;TCON(5)=6e-4*4.182;TCON(6)=5.2e-3*4.182;% ZENG origial TCON(3)=2.1e-2*4.182;TCON(4)=7e-3*4.182;TCON(5)=6e-4*4.182; % J cm^-1 s^-1 Cels^-1;                %
...
%          BCTB  =  20;  %ydy setting as the observed soil temperature at bottom
    end
end
if Soilairefc==1
