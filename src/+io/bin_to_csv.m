...
flu_names = {'simulation_number','nu_iterations','year','DoY',...
   ...
   'aPAR','aPAR_Cab','aPAR/rad.PAR','aPAR_Wm2','PAR','rad.Eoutf','rad.Eoutf./fluxes.aPAR_Wm2','Trap','Evap','ET','GPP','NEE','Sfactor'};
flu_units = {'','','','',  ...
    'W m-2','W m-2','W m-2',...
...
aerodyn_names = {'simulation_number','year','DoY',...
    'raa','rawc','raws','ustar','rac','ras','rscu','rsch','rss'};
aerodyn_units = {'','','',  ...
    's m-1','s m-1','s m-1', 'm s-1','s m-1','s m-1','s m-1','s m-1','s m-1'};
...
if options.calc_vegetation_dynamic   %ydy
