function [crop_output] = cropgrowth(meteo,wofostpar,Anet,xyt)
%CROPGROWTH 
%   aim to simulate the growth of vegetation

%% 0. global variables
global KT sfactor Dur_tot dvs wrt wlv wst wso dwrt dwlv dwst 
