% function Constants
global DeltZ Delt_t ML NS mL mN nD NL NN SAVE Tot_Depth Tmin InputPath
...
Tot_Depth=100;           % Unit is cm. it should be usually bigger than 0.5m. Otherwise, 
...
InitND1=10;    % Unit of it is cm. These variables are used to indicated the depth corresponding to the measurement.
InitND2=20;
InitND3=30;
InitND4=50;
InitND5=80;
...
if SWCC==0  
    ...
    InitT0=	21.89;  %-1.75estimated soil surface temperature-1.762
    InitT1=	21.89;
    InitT2=	21.71;
    InitT3=	21.31;
    InitT4=	20.28;
    ...
    BtmT=18.6841;  %9 8.1
    InitX0=	0.321;  
    InitX1=	0.321; % Measured soil liquid moisture content
    InitX2=	0.327; %0.169
    InitX3=	0.341; %0.205
    InitX4=	0.361; %0.114
    InitX5=	0.40;
    InitX6=	0.44;
    BtmX=0.44;%0.078 0.05;    % The initial moisture content at the bottom of the column.
% if SWCC==0  
% InitT0=	-1.762;  %-1.75estimated soil surface temperature-1.762
% InitT1=	-0.662;
% InitT2=	0.264;
